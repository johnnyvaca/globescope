...
<div class="divTable">
    <table class="table">
        ...
        <tr>
            ...
            <th scope="col">Psuedo<select>
                    <option></option>
                    <option>2</option>
                    <option>3</option>
                </select></th>
            <th><span>Tout Modifier</span><input type="checkbox" aria-label="Checkbox for following text input" id="toutModifier"></th>
