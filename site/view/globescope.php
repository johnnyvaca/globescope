...
<div id="sideBar" class="GUI">
    ...
    <div id="onClickDetails">
        ...
        <div id="description">
            ...
            <h5 id="childPseudo"></h5>
            <h5 id="childCitation"></h5>
            <h5 id="childRight"></h5>
            <span id="childCountry"></span>

            <span id="childTeam"></span>

            <a class="btn-success" id="lienMedia" target="_blank"><span id="childMedia"></span></a>

            <span>  <a class="btn btn-link" data-toggle="collapse" href="#collapseExample" role="button"
                       aria-expanded="false" aria-controls="collapseExample">
                   clique pour voir la description du média
                </a>
                  </span>

            <div class="collapse" id="collapseExample">
                <div class="card card-body" id="childMediaDesc">
                </div>
            </div>
