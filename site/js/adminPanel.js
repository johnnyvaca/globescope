...
function changeSelects(value, select, numeroPrincipal) {
    ...
    if( value == "avec"){
        $("tr  span:contains('"+select+"')").parent().next().next().next(":empty").parent().parent().addClass(select);
        $("tr  span:contains('"+select+"')").parent().next().next().next(":empty").parent().nextAll('td:last-child').prev().children(":checkbox").prop("checked", false)
    }
    if( value == "sans"){
        $("tr  span:contains('"+select+"')").parent().next().next().next().not(":empty").parent().parent().addClass(select);
        $("tr  span:contains('"+select+"')").parent().next().next().next().not(":empty").parent().nextAll('td:last-child').prev().children(":checkbox").prop("checked", false)

    }

    if( value !== "" && value !== "tous" &&  value !== "avec" &&  value !== "sans" ) {

        $("tr  span:contains('"+select+"')").parent().next().next().next().not(":contains('"+value+"')").parent().parent().addClass(select);
        $("tr  span:contains('"+select+"')").parent().next().next().next().not(":contains('"+value+"')").parent().nextAll('td:last-child').prev().children(":checkbox").prop("checked", false)

    }
    $("tbody").removeClass(select);
